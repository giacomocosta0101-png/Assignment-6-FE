...
%   price              : [scalar] Present value of the Bermudan swaption at t=0.
    ...
    for i = N_steps : -1 : 1
        ...
        % Compute exact HW stochastic discounts (UP, MID, DOWN branches)
        [Du, Dm, Dd] = compute_stochastic_discount(x_grid, B_t_t1, dx, mu_hat, a, sigma, dt);
        
        % 5. CONTINUATION VALUE CALCULATION
